...
POOL_ONE = [
    ...
    "fruit", "roam", 
    "goats", "woozy", "limbs", "ahead", "señor", "unicorn", "faraway", 
    "heater", "pirates", "understand", "wooden", "leaning", "breakfast", 
    "window", "acrobat", "message", "chocolate", "forepaw", "elephant", 
    "hedgehog", "recipe", "garbage", "surprise", "mermaid", "bombarded", 
    "disability", "incredible", "leather", "countess", "nervous", 
    "peppercorn", "cartwheel", "raise", "weather", "zooming", "attacked", 
    "turnout", "eaten", "streetlights", "journey", "courtyard", "shouting", 
    "asleep", "curious", "dinosaur", "brilliant", "vacuum", "gorgeous", 
    "monsoon", "dangerous", "avocado", "valentine", "February", 
...
WORD_DATA = {
    ...
    "woozy": ["Feeling unsteady, dizzy, or lightheaded.", "The spinning teacup ride made me feel a bit woozy."],
    "limbs": ["The arms or legs of a person or animal, or the large branches of a tree.", "The squirrel jumped from one of the tree's thick limbs."],
    "ahead": ["In a forward direction or further along in space or time.", "Look straight ahead to see the finish line."],
    "señor": ["A Spanish title of respect for a man, similar to 'Mr.'.", "The waiter greeted the gentleman by saying, 'Good evening, señor.'"],
    "unicorn": ["A mythical animal resembling a horse with a single horn on its forehead.", "The storybook described a magical unicorn living in the forest."],
    "faraway": ["At a great distance; remote.", "I often dream of traveling to faraway lands."],
    "heater": ["A device used for warming the air in a room or building.", "We turned on the heater when the house got chilly in the winter."],
    "pirates": ["People who attack and rob ships at sea.", "The pirates searched for the buried treasure on the island."],
    "understand": ["To perceive the intended meaning of something.", "I finally understand how to solve this math problem."],
    "wooden": ["Made of wood or stiff and awkward like wood.", "He carved a beautiful wooden bowl from a piece of oak."],
    "leaning": ["To be in a sloping position or to rest against something for support.", "She was leaning against the wall while waiting for the bus."],
    "breakfast": ["The first meal of the day, typically eaten in the morning.", "I had eggs and toast for breakfast today."],
    "window": ["An opening in a wall or door to let in light or air.", "The cat sat on the ledge looking out the window."],
    "acrobat": ["A person who performs gymnastic feats.", "The acrobat walked across the high wire with ease."],
    "message": ["A verbal, written, or recorded communication sent to a recipient.", "I left a message on the whiteboard for my teacher."],
    "chocolate": ["A food preparation made from roasted and ground cacao seeds.", "My favorite dessert is a warm chocolate brownie."],
    "forepaw": ["One of the front feet of a four-legged animal.", "The dog offered its forepaw to its owner to shake hands."],
    "elephant": ["A very large herbivorous mammal with a trunk and tusks.", "The elephant used its trunk to spray water on its back."],
    "hedgehog": ["A small nocturnal mammal with a spiny coat and short legs.", "The hedgehog rolled into a prickly ball when it felt scared."],
    "recipe": ["A set of instructions for preparing a particular dish.", "My grandmother shared her secret recipe for apple pie."],
    "garbage": ["Wasted or spoiled food and other refuse.", "Please take the garbage out to the bin before it smells."],
    "surprise": ["An unexpected or astonishing event, fact, or thing.", "We planned a big surprise party for Mom's birthday."],
    "mermaid": ["A mythical sea creature with the head and trunk of a woman and the tail of a fish.", "The little mermaid swam through the coral reef."],
    "bombarded": ["To attack continuously with questions, criticisms, or information.", "The famous actor was bombarded with questions from reporters."],
    "disability": ["A physical or mental condition that limits a person's movements, senses, or activities.", "The building has a ramp to help people with a physical disability."],
    "incredible": ["Impossible to believe or extraordinary.", "The view from the top of the mountain was truly incredible."],
    "leather": ["A material made from the skin of an animal by tanning or a similar process.", "He wore a sturdy leather jacket to stay warm."],
    "countess": ["A woman holding the rank of a count or earl.", "The countess lived in a grand castle in the countryside."],
    "nervous": ["Feeling worried, anxious, or slightly afraid.", "I felt nervous before giving my speech in front of the class."],
    "peppercorn": ["The dried berry of a pepper plant, used whole or ground as a spice.", "The chef added a fresh peppercorn to the soup for flavor."],
    "cartwheel": ["A circular sideways gymnastic movement.", "She performed a perfect cartwheel on the grass."],
    "raise": ["To lift or move something to a higher position.", "Please raise your hand if you have a question."],
    "weather": ["The state of the atmosphere at a place and time.", "The weather was sunny and warm all weekend."],
    "zooming": ["Moving or traveling very quickly.", "The race car was zooming around the track."],
    "attacked": ["To take aggressive action against something or someone.", "The castle was attacked by the enemy army."],
    "turnout": ["The number of people attending an event.", "There was a huge turnout for the school's talent show."],
    "eaten": ["The past participle of 'eat'; to have consumed food.", "I have already eaten my lunch."],
    "streetlights": ["Lamps on a stand at the side of a road.", "The streetlights turned on as the sun began to set."],
    "journey": ["An act of traveling from one place to another.", "The explorers began their long journey across the desert."],
    "courtyard": ["An unroofed area that is completely or partially enclosed by walls.", "We ate our lunch in the beautiful courtyard of the museum."],
    "shouting": ["Calling out or speaking loudly and forcefully.", "The coach was shouting instructions from the sidelines."],
    "asleep": ["In a state of sleep.", "The baby finally fell fast asleep in the crib."],
    "curious": ["Eager to know or learn something.", "The curious kitten explored every corner of the room."],
    "dinosaur": ["A fossil reptile of the Mesozoic era, often reaching an enormous size.", "We saw a giant dinosaur skeleton at the museum."],
    "brilliant": ["Exceptionally clever, talented, or very bright.", "The scientist came up with a brilliant idea for a new invention."],
    "vacuum": ["A space entirely devoid of matter, or a machine used for cleaning floors.", "I used the vacuum to pick up the crumbs on the rug."],
    "gorgeous": ["Beautiful; very attractive.", "The sunset over the ocean looked absolutely gorgeous."],
    "monsoon": ["A seasonal prevailing wind that brings very heavy rain.", "The farmers welcomed the monsoon rains for their thirsty crops."],
    "dangerous": ["Able or likely to cause harm or injury.", "It is dangerous to play near the busy highway."],
    "avocado": ["A pear-shaped fruit with rough green skin and a large stone.", "I like to spread mashed avocado on my toast."],
